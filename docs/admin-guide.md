...
should read [`integration-guide.md`](integration-guide.md) instead; operators running the relay,
Redis, and backups should read [`activity-infrastructure.md`](activity-infrastructure.md).
...
[the integration guide](integration-guide.md#retract-an-event-you-published). That is the right
...
[`activity-infrastructure.md`](activity-infrastructure.md#health-check).
