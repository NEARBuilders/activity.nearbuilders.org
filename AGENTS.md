...
Work is tracked in GitHub Issues for `NEARBuilders/activity.nearbuilders.org`. See `docs/agents/issue-tracker.md`.

### Triage labels

Use the canonical Matt Pocock engineering-skill label vocabulary. See `docs/agents/triage-labels.md`.
